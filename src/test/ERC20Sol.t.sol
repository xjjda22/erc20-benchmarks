...
import {ERC20SolMock} from "../mocks/ERC20SolMock.sol";
import {console} from "../utils/Console.sol";


contract ERC20SolTest is Test {
    ERC20SolMock m20;
    ...
    function setUp() public {
        ...
        initAcc = msg.sender;
        m20 = new ERC20SolMock('ERC20SolMOCKBENCH','E20SB', 18, initAcc, 1e77);
    ...
    function testC() public {
        ...
        assertEq(m20.name(),'ERC20SolMOCKBENCH');
        assertEq(m20.symbol(),'E20SB');
